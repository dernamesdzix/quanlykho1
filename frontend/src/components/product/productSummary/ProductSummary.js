    ...
    return (
        <div className='product-summary'>
            ...
            <div className='info-summary'>
                ...
                <InfoBox icon={earningIcon} title={"Total Stock Value"} 
                count={`$ ${formatNumbers(totalStoreValue.toFixed(2))}`} bgColor='card2' />
                <InfoBox icon={outOfStockIcon} title={"Out OF Stock"} 
                count={outOfStock} bgColor='card3' />
                <InfoBox icon={categoryIcon} title={"All Category"} 
